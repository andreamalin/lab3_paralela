...
int main(void) {
   ...
   Print_vector(x, 10, "x RANDOM -> The first 10 elements are:");
   Print_vector(y, 10, "y RANDOM -> The first 10 elements are:");
   Print_vector(z, 10, "The first 10 elements are:");
   printf("\n");

   Print_vector(x+n-10, 10, "x RANDOM -> The last 10 elements are:");
   Print_vector(y+n-10, 10, "y RANDOM -> The last 10 elements are:");
   Print_vector(z+n-10, 10, "The last 10 elements are:");
